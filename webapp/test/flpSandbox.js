		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#athochschuleburgenlandinenpibm-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"athochschuleburgenlandinenpibm-display": {
								"semanticObject": "athochschuleburgenlandinenpibm",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=at.hochschule.burgenland.inenpibm",
									"url": sap.ui.require.toUrl("at/hochschule/burgenland/inenpibm")
								}
							}
						}
					}
